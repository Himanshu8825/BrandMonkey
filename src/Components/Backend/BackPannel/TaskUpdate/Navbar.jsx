...
import RaisedComplained from "../../../../../public/ComplainedProfile.png";
import { ArchiveBook } from "../../../Icon";
    ...
    <div>
      <div className=" absolute   left-8 top-[20%] ml-8">
        <div className="flex  flex-col  mt-[-10px] justify-center items-center">
          ...
          <img src={RaisedComplained} width={60} height={60} alt="" />
      ...
      <div className=" absolute  left-7 top-[72%] ml-8">
        <div className="flex gap-2">
          <ArchiveBook />
          <p className="font-poppins font-semibold mt-0">Task Uploaded</p>
        </div>
      </div>
