  ...
  return (
    <div>
      <div className="flex mt-3 mr-8">
        <div className="m-2 gradient p-2 rounded-2xl flex justify-center items-center">
          <Setting />
        </div>
        <div className="m-2 gradient p-2 rounded-full flex justify-center items-center">
          <Notification />
        </div>
